...
(() => {
  ...
  var __name = (target, value) => __defProp(target, "name", { value, configurable: !0 }), __require2 = ((x) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(x, {
  ...
  function _wrapNativeSuper(t) {
    ...
    return _wrapNativeSuper = __name(function(t2) {
      ...
      return __name(Wrapper2, "Wrapper"), Wrapper2.prototype = Object.create(t2.prototype, {
        constructor: {
          value: Wrapper2,
          enumerable: !1,
          writable: !0,
...
`
  ...
  var reduceHexValue = __name(function(value) {
  ...
  })), EmptyBlock = __name((props) => react_default.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" }), "EmptyBlock"), StyledSyntaxHighlighter = styled(
    SyntaxHighlighter
  )(({ theme }) => ({
  ...
  addons.register(ADDON_ID, (api) => {
    addons.add(PANEL_ID, {
       ...
       * ```
       */
      disabled: __name((parameters) => !parameters?.docs?.codePanel, "disabled"),
      match: __name(({ viewMode }) => viewMode === "story", "match"),
      render: __name(({ active }) => {
